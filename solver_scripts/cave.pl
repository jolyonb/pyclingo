...
% Generated by pyclingo on 2025-05-27 09:42:35
...
min_row_for_cave_anchor(MinR) :- MinR = #min{R : cave(cell(R, C)), R = 1..9}.
cave_anchor(cell(MinR, MinC)) :- min_row_for_cave_anchor(MinR), MinC = #min{C : cave(cell(MinR, C)), C = 1..9}.
