...
from aspalchemy.program_elements import BlankLine, Comment, ProgramElement, RawASP, RenderedLine, Rule
from aspalchemy.scoping import validate_optimization_element, validate_weak_constraint
...
class Segment:
    ...
    def raw_asp(self, text: str, predicates: Sequence[type[Predicate] | NegatedSignature] = ()) -> None:
        ...
        (atoms carrying escaped strings are the exception — aspalchemy has no
        ...
        under the aspalchemy verbs: #project does nothing until the solve
