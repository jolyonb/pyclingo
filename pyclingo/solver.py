...
class ASPProgram:
    ...
    def __init__(
        self, header: str | None = None, default_segment: str = "Rules"
    ) -> None:
    ...
    def when(
        ...
        self._segments[segment or self.default_segment].append(
            Rule(head=let, body=condition_list)
        )
    ...
    def render(self) -> str:
        ...
        show_statements = {
            pred.get_show_directive() for pred in self._collect_predicates()
        }
