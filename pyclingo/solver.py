...
class ASPProgram:
    ...
    def _collect_used_defined_constants(self) -> set[str]:
        """
        Collect all defined constant names used in the program.

        Returns:
            set[str]: Set of defined constant names used in the program.
        """
        constants = set()
    ...
    def _validate_constants(self) -> None:
        """
        Validate that all defined constants used in the program were declared via define_constant().
